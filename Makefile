...
SOURCES       = main.cpp \
		...
		model/videoD.cpp \
		visitor/JSONvisitor.cpp moc_MainWindow.cpp
OBJECTS       = main.o \
		biblioteca.o \
		fileManager.o \
		MainWindow.o \
...
main.o: main.cpp fileManager/include/biblioteca.hpp \
		model/include/contenutoMultimediale.hpp \
...
MainWindow.o: gui/MainWindow.cpp 
